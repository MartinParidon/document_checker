...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_phrases_file_path = QLineEdit(self.centralwidget)
        ...
        self.pushButton_words_file_path = QPushButton(self.centralwidget)
        ...
        self.lineEdit_output_folder_path = QLineEdit(self.centralwidget)
        ...
        self.lineEdit_words_file_path = QLineEdit(self.centralwidget)
        ...
        self.lineEdit_input_folder_path = QLineEdit(self.centralwidget)
        ...
        self.pushButton_input_folder_path = QPushButton(self.centralwidget)
        ...
        self.pushButton_output_folder_path = QPushButton(self.centralwidget)
        ...
        self.pushButton_phrases_file_path = QPushButton(self.centralwidget)
